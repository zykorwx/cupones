...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Empresa.nombre_encargado'
        db.alter_column(u'empresa_empresa', 'nombre_encargado', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Empresa.nombre_encargado'
        db.alter_column(u'empresa_empresa', 'nombre_encargado', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        u'empresa.empresa': {
            ...
            'nombre_encargado': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
