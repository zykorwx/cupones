...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cupon.user'
        db.add_column(u'cupon_cupon', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=22, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cupon.user'
        db.delete_column(u'cupon_cupon', 'user_id')
