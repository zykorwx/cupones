...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promocion.descripcion'
        db.alter_column(u'cupon_promocion', 'descripcion', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Promocion.descripcion'
        db.alter_column(u'cupon_promocion', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=200))
