...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cupon', ['Tag'])

        # Adding model 'Tag_promocion'
        db.create_table(u'cupon_tag_promocion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('promocion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cupon.Promocion'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cupon.Tag'])),
        ))
        db.send_create_signal('cupon', ['Tag_promocion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Tag'
        db.delete_table(u'cupon_tag')

        # Deleting model 'Tag_promocion'
        db.delete_table(u'cupon_tag_promocion')
    ...
    models = {
        ...
        'cupon.tag_promocion': {
            'Meta': {'object_name': 'Tag_promocion'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'promocion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cupon.Promocion']"}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cupon.Tag']"})
        },
        'empresa.empresa': {
